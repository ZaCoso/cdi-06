...
int main() {
  ...
  while (1){
    ...
    char pin_cero = gpio_get(0);
    char pin_uno = gpio_get(1);
    char pin_dos = gpio_get(2);
    char pin_tres = gpio_get(3);
    if (pin_cero == true && pin_uno == true && pin_dos == true && pin_tres == true)
    {
      println ("Abierto:",)
    }
  }
